...
p1 = ggplot(south_yorkshire, aes(x = District, y = DrugOffenseRate)) +
...
p2 = ggplot(west_yorkshire, aes(x = District, y = DrugOffenseRate)) +
...
school_data_2022_SY <- SchoolPerformances %>%
  filter(tolower(County) == "south yorkshire", Year == "2021-2022") %>%
